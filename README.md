...
(Elastic Container Service is not a free tier service so i deactivated the back end api, please contact me to test it via front-end application)
...
(Elastic Container Service is not a free tier service so i deactivated the back end api, please contact me to test it via back-end application)
